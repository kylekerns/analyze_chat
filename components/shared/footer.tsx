  ...
  return (
    <footer className="py-16">
      <div className="mx-auto max-w-5xl px-6">
        <Link
          href="/"
          className="font-bold text-lg sm:text-xl flex items-center justify-center gap-1 sm:gap-2"
        >
          <Image
            src="/logo.png"
            alt="ChemistryCheck"
        ...
        <div className="flex flex-col gap-4 mt-6 mb-8">
          ...
          <div className="flex justify-center items-center gap-4">
            <Link href="https://www.uneed.best/tool/chemistrycheck">
              <Image
                src="/uneed-best.png"
            ...
            <Link
              href="https://www.tinylaun.ch/launch/2959"
              target="_blank"
              rel="noopener"
            >
              <Image
